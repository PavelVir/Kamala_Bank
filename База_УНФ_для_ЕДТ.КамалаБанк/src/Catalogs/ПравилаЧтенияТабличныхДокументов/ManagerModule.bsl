...
Процедура ОбработкаПолученияФормы(ВидФормы, Параметры, ВыбраннаяФорма, ДополнительнаяИнформация, СтандартнаяОбработка)
	...
	Если ТипЗнч(Параметры) = Тип("Структура") Тогда
		...
		Если Параметры.Свойство("Ключ") И ЗначениеЗаполнено(Параметры.Ключ)			
			Или (Параметры.Свойство("ЗначениеКопирования") и ТипЗнч(Параметры.ЗначениеКопирования) = Тип("СправочникОбъект.ПравилаЧтенияТабличныхДокументов")) 
...
Функция НовыйСписокПоказателейВыпискиБанка() 
	...
	НоваяСтрокаПоказателя(Результат, "Рсчет",  НСтр("ru='Счет организации'"), Новый ОписаниеТипов("СправочникСсылка.БанковскиеСчета"),
			НСтр("ru='Ячейка с номером или наименованием счета. Используется для идентификации счета организации'"));
	НоваяСтрокаПоказателя(Результат, "Дата", НСтр("ru='Дата операции'"), ТипДата,
			НСтр("ru='Дата, на которую должна быть создана операция'"));
	НоваяСтрокаПоказателя(Результат, "НомерПП", НСтр("ru='Входящий номер операции'"), ТипСтрока,
			НСтр("ru='Входящий номер операции'"));         		
	...
	НоваяСтрокаПоказателя(Результат, "РСчетКонтрагент", НСтр("ru='Расчетный счет контрагента'"), ТипСтрока,
 			НСтр("ru='Ячейка с номером или наименованием счета. Используется для идентификации счета контрагента'"));
	НоваяСтрокаПоказателя(Результат, "ЕДРПОУКонтрагент", НСтр("ru='ЕДРПОУ контрагента'"), ТипСтрока,
 			НСтр("ru='Ячейка с номером ЕДРПОУ. Используется для идентификации контрагента'"));
	НоваяСтрокаПоказателя(Результат, "Контрагент", НСтр("ru='Наименование контрагента'"), ТипСтрока,
 			НСтр("ru='Наименование контрагента. Используется для создания контрагента'"));
	НоваяСтрокаПоказателя(Результат, "НазначениеПлатежа", НСтр("ru='Назначение платежа'"), ТипСтрока,
